...
const ParallaxPills: React.FC<ParallaxPillsProps> = ({
  ...
  return (
    <div
      ref={containerRef}
      className={["parallax-pills-root", className].filter(Boolean).join(" ")}
      style={{ width, height }}
    >
      {!disableEmptyPills &&
