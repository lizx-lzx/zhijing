...
*{box-sizing:border-box}body{margin:0;background:#f5f1e8;color:#2b2926;font-family:"Noto Sans CJK SC","PingFang SC","Microsoft YaHei",sans-serif}button{font:inherit;cursor:pointer}.frame{min-height:100vh;padding:4.2vh 4.5vw;display:flex;flex-direction:column;gap:2vh;overflow:hidden}.eyebrow{font-size:clamp(14px,1.8vw,24px);color:#8d301f;display:flex;justify-content:space-between;gap:16px}h1{font-family:"Noto Serif CJK SC","Songti SC",serif;font-weight:500;font-size:clamp(25px,3.5vw,46px);line-height:1.3;margin:0;max-width:1100px}h2{font-size:clamp(21px,2.8vw,36px);margin:0 0 12px;line-height:1.4}.kind{margin-right:12px;color:#736b61}.diagram{display:flex;align-items:stretch;gap:20px;flex:1;min-height:0;margin:3vh 0}.item{flex:1;background:#fbf8f1;border:1px solid #ded7c9;border-radius:4px;padding:28px 22px;align-self:center;min-height:210px;display:flex;flex-direction:column;justify-content:center;transition:none}.item.active{background:#f2e4db;border-color:#b3402a}.label{font-size:clamp(21px,3.2vw,42px);line-height:1.4;font-weight:600;margin-bottom:14px}.detail{font-size:clamp(16px,2vw,27px);line-height:1.5;color:#736b61}.arrow{align-self:center;font-size:24px;color:#8a8174;max-width:80px;text-align:center}.arrow small{display:block;font-size:14px}.caption{background:#ebe5d9;color:#2b2926;border-radius:4px;padding:18px 24px;font-size:clamp(18px,2.15vw,28px);line-height:1.6;min-height:80px}.footer{display:flex;justify-content:space-between;color:#736b61;font-size:14px;gap:12px}.progress{height:4px;background:#ded7c9;margin-top:8px}.progress span{display:block;height:100%;background:#b3402a}.controls{display:flex;align-items:center;gap:10px;flex-wrap:wrap;padding:16px 4.5vw;border-top:1px solid #ded7c9}button{border:1px solid #ded7c9;border-radius:9px;background:#fbf8f1;padding:9px 14px;color:#2b2926}button:focus-visible{outline:3px solid #b3402a;outline-offset:3px}button:first-child{background:#b3402a;color:#fff;border-color:#b3402a}button:disabled{opacity:.45;cursor:default}.frame.capture{height:720px;min-height:720px}.capture .caption{font-size:27px}.capture .label{font-size:37px}.capture .detail{font-size:23px}.capture h1{font-size:43px}.capture .diagram{margin:12px 0}.capture .item{padding:24px 20px}.capture .eyebrow{font-size:21px}.capture .footer{font-size:17px}audio{display:none}@media(max-width:650px){.frame{padding:22px 20px}.diagram{flex-direction:column;gap:12px;flex:initial;margin:12px 0}.item{width:100%;padding:20px;min-height:100px}.arrow{font-size:18px;transform:rotate(90deg);height:12px}.arrow small{display:none}.label{margin-bottom:8px}.caption{padding:16px}.eyebrow{font-size:14px}.footer{font-size:13px}h1{font-size:26px}}
...
export function diagramSVG(chapter) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="960" height="${height}" viewBox="0 0 960 ${height}"><rect width="960" height="${height}" fill="#f5f1e8"/><style>text{font-family:"Noto Sans CJK SC","PingFang SC",sans-serif;fill:#2b2926}</style><text x="50" y="65" font-size="30">${esc(chapter.title)}</text>${items
    .map(
      (v, i) =>
        `<rect x="50" y="${110 + i * 155}" width="860" height="125" rx="4" fill="#ebe5d9"/><text x="80" y="${150 + i * 155}" font-size="27">${esc(v.label)}</text><text x="80" y="${187 + i * 155}" font-size="20">${wrap(
          v.detail,
          35,
        )
          .slice(0, 2)
