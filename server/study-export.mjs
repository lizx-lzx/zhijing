...
*{box-sizing:border-box}body{margin:0;background:#f7f8fc;color:#202b42;font:17px/1.9 system-ui,"PingFang SC",sans-serif}main{max-width:900px;padding:32px 24px;margin:auto}h1{font-size:32px;line-height:1.4}h2{font-size:25px;line-height:1.6}h3{font-size:20px}section{border-top:1px solid #dbe1ef;padding:24px 0}a{color:#4c50c7}nav{display:flex;flex-wrap:wrap;gap:12px}details{margin:16px 0;padding:14px 18px;border:1px solid #dbe1ef;border-radius:12px;background:white}summary{cursor:pointer}svg{width:100%;max-width:640px;height:auto}blockquote{border-left:3px solid #939cdf;padding-left:18px;margin-left:0}.note{background:#edeffd;padding:18px;border-radius:12px}.source{font-size:15px;color:#53627a}audio{width:100%}@media print{body{background:white}details{break-inside:avoid}audio{display:none}}
